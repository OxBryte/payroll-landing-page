      ...
      <Container>
        <div className="w-full p-6 md:py-20 z-10 flex flex-col justify-center items-center">
          ...
          <div className="w-fit grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
            <div className="text-white p-10 rounded-2xl border border-white/20 overflow-hidden relative max-w-[360px] h-[330px] flex flex-col justify-end items-center gap-6">
